...
%     plot(xdata(nonzerodataWLS),data(i,nonzerodataWLS),'k.')
    ...
    exportfig(gcf,[welllet num2str(well) '_fits_to_data_WLS_MLE_D' Dtype '_' num2str(count) '.eps'],'color','rgb')
    saveas(gcf,[welllet num2str(well) '_fits_to_data_WLS_MLE_D' Dtype '_' num2str(count) '.fig'])
