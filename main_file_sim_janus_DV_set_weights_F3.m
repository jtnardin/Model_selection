...
for i = 1:length(xnsize)
    for j = 1:length(model_sim)
        ...
        [q,J] = fmincon(@(q) MLE_cost_DV_set_weights(data,q,x,dx,xn,x_int,xbd_0,xbd_1,t,dt,tn,tdata,xdata,LE_loc,...
        ...
        save(['/lustre/janus_scratch/jona8898/spline_vel/MLE_EST_' welllet num2str(well) '_WLS_set_DV.mat' ],...
