...
function udata = diff_conv_f_vel_spline_OLS_DV(q,x,dx,xn,x_int,xbd_0,xbd_1,t,dt,tn,tdata,xdata,LE_loc,...
    ...
    elseif modelno == 2
        ...
        v_spline = spmak(tsamp,q(2:end-1));
    ...
    for i = 2:tn
        ...
        if V(t(i)) >= 0
            ...
            Ax_exp = A_pos(sigma(r_e),sigma(r_w),Dx_c(t(i-1)),Vx_c(t(i-1)),x_int,1);
            Ax_imp = A_pos(sigma(r_e),sigma(r_w),Dx_c(t(i-1)),Vx_c(t(i)),x_int,1);
